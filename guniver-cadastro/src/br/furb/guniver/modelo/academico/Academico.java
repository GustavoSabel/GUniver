...
public class Academico {
    ...
    public Matricula[] buscarMatriculas(br.furb.guniver.modelo.cadastro.Aluno aluno) throws Exception {
	return getAcademico().getMatriculasAluno(aluno.getCodigo());
    }
    
    public Matricula[] buscarMatriculas(br.furb.guniver.modelo.cadastro.Turma turma) throws Exception {
