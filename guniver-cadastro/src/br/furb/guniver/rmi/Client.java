...
public class Client {
	...
	CursoRemote cursoRemote = (CursoRemote) Naming.lookup("//" + endereco + "/CursoRemote");
	...
	DisciplinaRemote disciplinaRemote = (DisciplinaRemote) Naming.lookup("//" + endereco + "/DisciplinaRemote");
	...
	TurmaRemote turmaRemote = (TurmaRemote) Naming.lookup("//" + endereco + "/TurmaRemote");
