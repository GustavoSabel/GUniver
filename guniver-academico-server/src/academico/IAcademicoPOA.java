 ...
 implements academico.IAcademicoOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getOcorrencias", new java.lang.Integer (1));
    _methods.put ("getMatricula", new java.lang.Integer (2));
    _methods.put ("getMatriculas", new java.lang.Integer (3));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // academico/IAcademico/getOcorrencias
       {
         academico.Aluno aluno = academico.AlunoHelper.read (in);
       ...
       case 3:  // academico/IAcademico/getMatriculas
       {
         academico.Aluno aluno = academico.AlunoHelper.read (in);
         academico.Matricula $result[] = null;
