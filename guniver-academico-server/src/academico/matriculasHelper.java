...
abstract public class matriculasHelper
{
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = academico.MatriculaHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (academico.matriculasHelper.id (), "matriculas", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    academico.Matricula value[] = null;
    int _len0 = istream.read_long ();
    value = new academico.Matricula[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = academico.MatriculaHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, academico.Matricula[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      academico.MatriculaHelper.write (ostream, value[_i0]);
  }
