 ...
 implements br.furb.guniver.modelo.academico.IAcademicoOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("cadastrarMatricula", new java.lang.Integer (4));
  ...
  //matriculas getMatriculasSemestre(in long codigoAluno, in short ano, in short semestre);
       case 4:  // academico/IAcademico/cadastrarMatricula
       {
         br.furb.guniver.modelo.academico.Matricula matricula = br.furb.guniver.modelo.academico.MatriculaHelper.read (in);
         org.omg.CORBA.StringHolder mensagemErro = new org.omg.CORBA.StringHolder ();
         int $result = (int)0;
         $result = this.cadastrarMatricula (matricula, mensagemErro);
         out = $rh.createReply();
