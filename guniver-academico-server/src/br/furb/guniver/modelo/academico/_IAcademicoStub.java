...
public class _IAcademicoStub extends org.omg.CORBA.portable.ObjectImpl implements br.furb.guniver.modelo.academico.IAcademico
{
  ...
  public br.furb.guniver.modelo.academico.Prova[] getNotasAluno (int codigoAluno, int codigoTurma)
  {
  ...
  public boolean matricular (br.furb.guniver.modelo.academico.Aluno aluno, br.furb.guniver.modelo.academico.Turma turma, org.omg.CORBA.StringHolder mensagemErro)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("matricular", true);
                br.furb.guniver.modelo.academico.AlunoHelper.write ($out, aluno);
                br.furb.guniver.modelo.academico.TurmaHelper.write ($out, turma);
                $in = _invoke ($out);
