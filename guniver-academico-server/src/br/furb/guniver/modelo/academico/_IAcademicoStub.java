...
public class _IAcademicoStub extends org.omg.CORBA.portable.ObjectImpl implements br.furb.guniver.modelo.academico.IAcademico
{
  ...
  public int cadastrarMatricula (br.furb.guniver.modelo.academico.Matricula matricula, org.omg.CORBA.StringHolder mensagemErro)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("cadastrarMatricula", true);
                br.furb.guniver.modelo.academico.MatriculaHelper.write ($out, matricula);
                $in = _invoke ($out);
                ...
                return cadastrarMatricula (matricula, mensagemErro        );
            } finally {
                _releaseReply ($in);
            }
  } // cadastrarMatricula
  ...
  public int cadastrarProva (br.furb.guniver.modelo.academico.Prova prova, org.omg.CORBA.StringHolder mensagemErro)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
