...
@XmlRootElement(name = "consultarCompromissosResponse", namespace = "http://webservice_guniver/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "consultarCompromissosResponse", namespace = "http://webservice_guniver/")
public class ConsultarCompromissosResponse {
