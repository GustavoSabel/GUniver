...
@XmlRootElement(name = "consultarCompromissosAlunoResponse", namespace = "http://webservice_guniver/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "consultarCompromissosAlunoResponse", namespace = "http://webservice_guniver/")
public class ConsultarCompromissosAlunoResponse {
