...
public class CadastrarCompromissoResponse {
    ...
    private webservice_guniver.Compromisso _return;
     ...
     *     returns Compromisso
     */
    public webservice_guniver.Compromisso getReturn() {
        return this._return;
    }
     ...
     */
    public void setReturn(webservice_guniver.Compromisso _return) {
