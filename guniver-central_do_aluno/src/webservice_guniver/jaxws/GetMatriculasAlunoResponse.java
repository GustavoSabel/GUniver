...
@XmlRootElement(name = "getMatriculasAlunoResponse", namespace = "http://webservice_guniver/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getMatriculasAlunoResponse", namespace = "http://webservice_guniver/")
