...
public abstract class IAcademicoPOA extends org.omg.PortableServer.Servant
 implements servico.academico.IAcademicoOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // academico/IAcademico/getNotasAluno
       {
         ...
         servico.academico.Prova $result[] = null;
         $result = this.getNotasAluno (codigoAluno, codigoTurma);
         out = $rh.createReply();
         servico.academico.provasHelper.write (out, $result);
         break;
       }
       ...
       case 1:  // academico/IAcademico/getMatricula
       {
         ...
         servico.academico.Matricula $result = null;
         $result = this.getMatricula (codigoAluno, codigoDisciplina);
         out = $rh.createReply();
         servico.academico.MatriculaHelper.write (out, $result);
         break;
       }
       ...
       case 2:  // academico/IAcademico/getMatriculasAluno
       {
         ...
         out = $rh.createReply();
         servico.academico.matriculasHelper.write (out, $result);
         break;
       }
  ...
  //matriculas getMatriculasSemestre(in long codigoAluno, in short ano, in short semestre);
       ...
       {
         servico.academico.Aluno aluno = servico.academico.AlunoHelper.read (in);
         servico.academico.Turma turma = servico.academico.TurmaHelper.read (in);
       ...
       {
         int codigoTurma = in.read_long ();
         servico.academico.Horario $result[] = null;
         $result = this.getHorarios (codigoTurma);
         out = $rh.createReply();
         servico.academico.horariosHelper.write (out, $result);
         break;
       }
  ...
  //boolean cadastrarDisciplina(in Disciplina disciplina, out string mensagemErro);
       ...
       {
         servico.academico.Prova prova = servico.academico.ProvaHelper.read (in);
         org.omg.CORBA.StringHolder mensagemErro = new org.omg.CORBA.StringHolder ();
         boolean $result = false;
