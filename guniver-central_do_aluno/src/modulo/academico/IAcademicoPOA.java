...
public abstract class IAcademicoPOA extends org.omg.PortableServer.Servant
 implements modulo.academico.IAcademicoOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       case 0:  // academico/IAcademico/getNotasAluno
       {
         ...
         modulo.academico.Prova $result[] = null;
         $result = this.getNotasAluno (codigoAluno, codigoTurma);
         out = $rh.createReply();
         modulo.academico.provasHelper.write (out, $result);
         break;
       }
       ...
       case 1:  // academico/IAcademico/getMatricula
       {
         ...
         modulo.academico.Matricula $result = null;
         $result = this.getMatricula (codigoAluno, codigoDisciplina);
         out = $rh.createReply();
         modulo.academico.MatriculaHelper.write (out, $result);
         break;
       }
       ...
       case 2:  // academico/IAcademico/getMatriculasAluno
       {
         ...
         out = $rh.createReply();
         modulo.academico.matriculasHelper.write (out, $result);
         break;
       }
  ...
  //matriculas getMatriculasSemestre(in long codigoAluno, in short ano, in short semestre);
       ...
       {
         modulo.academico.Aluno aluno = modulo.academico.AlunoHelper.read (in);
         modulo.academico.Turma turma = modulo.academico.TurmaHelper.read (in);
       ...
       {
         int codigoTurma = in.read_long ();
         modulo.academico.Horario $result[] = null;
         $result = this.getHorarios (codigoTurma);
         out = $rh.createReply();
         modulo.academico.horariosHelper.write (out, $result);
         break;
       }
  ...
  //boolean cadastrarDisciplina(in Disciplina disciplina, out string mensagemErro);
       ...
       {
         modulo.academico.Prova prova = modulo.academico.ProvaHelper.read (in);
         org.omg.CORBA.StringHolder mensagemErro = new org.omg.CORBA.StringHolder ();
         boolean $result = false;
