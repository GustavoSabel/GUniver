...
@XmlRootElement(name = "getAlunosTurmaResponse", namespace = "http://webservice_guniver.guniver.furb.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAlunosTurmaResponse", namespace = "http://webservice_guniver.guniver.furb.br/")
