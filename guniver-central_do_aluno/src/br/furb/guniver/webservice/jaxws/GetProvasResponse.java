...
@XmlRootElement(name = "getProvasResponse", namespace = "http://webservice.guniver.furb.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProvasResponse", namespace = "http://webservice.guniver.furb.br/")
