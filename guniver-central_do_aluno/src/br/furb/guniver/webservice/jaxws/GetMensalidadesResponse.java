...
@XmlRootElement(name = "getMensalidadesResponse", namespace = "http://webservice.guniver.furb.br/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getMensalidadesResponse", namespace = "http://webservice.guniver.furb.br/")
