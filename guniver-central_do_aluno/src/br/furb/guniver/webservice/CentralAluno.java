...
public class CentralAluno {
	...
	public Collection<Prova> getProvas(int codigoAluno, int codigoTurma)
		...
		return ConversorAcademico.castProvas(academico.getProvas(codigoAluno,
				codigoTurma));
	}

	@WebMethod
	public Collection<Matricula> getMatriculasAluno(int codigoAluno)
			throws Exception {
		System.out.println("getMatriculasAluno");
		Academico academico = new Academico(Endereco.academico.getEndereco());
		return ConversorAcademico.castMatriculas(academico
				.getMatriculasAluno(codigoAluno));
	}

	@WebMethod
	public Collection<Matricula> getMatriculasTurma(int codigoTurma)
			throws Exception {
		System.out.println("getMatriculasTurma");
		Academico academico = new Academico(Endereco.academico.getEndereco());
		return ConversorAcademico.castMatriculas(academico
				.getMatriculasTurma(codigoTurma));
	}
	...
	public Collection<Horario> getHorarios(int codigoTurma) throws Exception {
		...
		Academico academico = new Academico(Endereco.academico.getEndereco());
		return ConversorAcademico.castHorarios(academico
				.getHorarios(codigoTurma));
	}
	...
	@WebMethod
	public List<Disciplina> getDisciplinas(int codigoCurso)
	...
	@WebMethod
	public List<Mensalidade> getMensalidadesPendentes(int codigoAluno)
			throws RemoteException {
	...
	@WebMethod
	public Aluno autenticaUsuario(String nomeUsuario, String senha)
			throws RemoteException {
		System.out.println("autenticaUsuario");
		Aluno aluno = Cadastro.getInstancia().getAlunoPorNomeUsuario(
				nomeUsuario);
