...
public class cliente {
	...
	public static void main(String args[]) {
		try {
			...
			Turma turmaSD = new Turma(3, "Turma SD", (short) 2014, (short) 2,
					discSD);
			Turma turmaPD = new Turma(55, "Turma PD", (short) 2014, (short) 1,
					discPD);
			...
			float[] notas = academico.getNotasAluno(aluno, turmaPD);
			System.out.println("Notas do(a) aluno(a) " + aluno.nome);
			for (int i = 0; i < notas.length; i++) {
				System.out.println(" - " + notas[i]);
			}

			Matricula[] matriculas = academico.getMatriculasSemestre(aluno,
					(short) 2014, (short) 1);
			System.out
					.println("O Aluno"
							+ aluno.nome
